...
\begin{itemize}
	...
	\begin{itemize}
		...
		\end{enumerate}
		\item pomocí CSS selektorů (tedy HTML tagy, třídy, id, hodnoty atributu, různé následnosti a vše ostatní, co CSS selektory umožňují, viz \href{https://www.w3schools.com/cssref/css_selectors.asp}{CSS selectors})
