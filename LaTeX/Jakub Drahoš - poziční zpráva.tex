...
\keywordsCS{web scraping, extrakce dat, aplikace, rozšíření do Chromu, JavaScript}
\keywordsEN{web scraping, data extraction, application, Chrome extension, JavaScript}
...
\begin{introduction}
	...
	V kapitole 1 této práce se budu věnovat 
\end{introduction}
...
(nebo také \textit{web harvesting, web data extraction}) je technika získávání nejrůznějších dat z~webových stránek. Nejčastěji se v~tomto kontextu jedná o~automatizovaný proces strojového zpracování a získávání dat, nicméně může jít i o~manuální extrakci zadanou uživatelem skrze nějaký software (jako je tomu právě v~našem případě). [citace z~Wiki - web scraping - nebo radši ne...]
...
Podrobná právní analýza celé problematiky web scrapingu by vydala na samostatnou diplomovou práci, a tak se pokusím pouze shrnout základní body a poskytnout čtenáři alespoň náhled do této oblasti.
...
Pro tuto práci mnohem relevantnější kategorií je konkurenční nabídka nástrojů poskytujících uživatelům rozhraní k~web scrapingu. Budu se zaměřovat pouze na takové nástroje, které nevyžadují jakoukoli znalost programování -- tedy žádné knihovny, API a nástroje pro budování vlastních scraperů.
...
\begin{thebibliography}{99}
	...
	\bibitem{click_wrap}
	OBAR, Jonathan A. a Anne OELDORF-HIRSCH. The Clickwrap: A Political Economic Mechanism for Manufacturing Consent on Social Media. \textit{Social Media + Society} [online]. 2018, roč. 4, č. 3 [cit. 1. 4. 2019]. DOI: 10.1177/2056305118784770. ISSN 2056-3051. Dostupné z \url{https://journals.sagepub.com/doi/10.1177/2056305118784770}
