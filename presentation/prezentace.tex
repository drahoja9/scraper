...
\begin{document}
	...
	\begin{frame}
		\begin{center}
			\movie[showcontrols=true]{\includegraphics[height=0.49\linewidth]{assets/video_snapshot.png}}{assets/ukazka2.avi}
		\end{center}
	\end{frame}

	\begin{frame}
	\begin{center}
		\movie[showcontrols=true]{\includegraphics[height=0.49\linewidth]{assets/video_snapshot.png}}{assets/ukazka2.mp4}
	\end{center}
\end{frame}
	...
	\begin{frame}
		\begin{center}
			\includemedia[
				...
				final,
				passcontext,
				addresource=assets/ukazka2.avi,
				flashvars={
					source=assets/ukazka2.avi&
